...
export { type Container, type ModuleFactory, type FeatureFactory, registerModules } from "./container/container.js";
...
export { sessionGuard, getSession, requireRole, Roles, type Role, type SessionPayload } from "./session/session.guard.js";
